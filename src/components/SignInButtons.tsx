...
export default function SignInButtons() {
  ...
  if (showPhone) {
    return <PhoneSignIn onBack={() => setShowPhone(false)} />;
  }
  ...
  return (
    <div className="flex flex-col gap-3 w-full">
      ...
      <button
        ...
        className="flex items-center justify-center gap-3 w-full py-4 px-4 rounded-full bg-white/10 text-white font-semibold text-sm hover:bg-white/15 transition-colors active:scale-[0.98]"
      >
        <Phone size={20} />
        {t("continueWithPhone")}
      </button>
