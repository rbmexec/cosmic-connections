...
export default function AttractionCard({ profile }: { profile: UserProfile }) {
  ...
  return (
    ...
    >
      ...
      />
      <div className="absolute inset-0 photo-gradient-deep" />
      ...
      >
        <CosmicInfo type="chineseZodiac" value={profile.chineseZodiac.animal}>
          <div className="glass-card-strong px-3 py-1.5 rounded-full flex items-center gap-1.5">
            ...
            <span className="text-xs font-semibold text-slate-200">{profile.chineseZodiac.animal}</span>
          </div>
        </CosmicInfo>
      </motion.div>
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 pb-7">
        <div className="flex items-end justify-between">
          <div className="flex-1">
            <motion.h2
              ...
              className="text-[28px] font-bold tracking-tight flex items-center gap-2"
            >
            ...
            <motion.div
              ...
              className="flex items-center gap-1.5 text-slate-200 text-sm mt-1"
            >
            ...
            <motion.div
              ...
              className="flex items-center gap-1.5 text-slate-400 text-xs mt-1"
            >
              <MapPin size={12} />
          ...
          <div className="flex flex-col items-center glass-card-strong rounded-2xl px-3 py-2">
            ...
            <span className="text-[9px] text-slate-400 uppercase tracking-wide">{t('lifePath')}</span>
          </div>
        </div>
        ...
        {profile.prompts.length > 0 && (
          <motion.div
            ...
            className="mt-4 p-3.5 rounded-2xl glass-card-strong"
          >
